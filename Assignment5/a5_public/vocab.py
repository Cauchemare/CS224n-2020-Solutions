...
class VocabEntry(object):
    ...
    def __init__(self, word2id=None):
        ...
        self.char2id['<unk>'] = 3  # <unk> token Û
    ...
    def to_input_tensor_char(self, sents: List[List[str]], device: torch.device) -> torch.Tensor:
        ...
        sents_char_padded = pad_sents_char(sents_char, self.char_pad)
        sents_var = torch.tensor(sents_char_padded,dtype=torch.long, device=device).transpose(0, 1)
